...
def create_env(use_gui=False, is_eval=False, obj_scale=1.0, obj_name="tomato_soup_can",
    ...
    OBS_CONFIG = {
        ...
        "relocate_noise": {
            "relocate": {
                "point_cloud": {"process_fn": process_relocate_pc_noise, "num_points": 512, "pose_perturb_level": (3, 1),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', type=str, default="noise_test_3")
    ...
    parser.add_argument('--dataset_path', type=str, default="data/data-noise-test-3.pkl")
