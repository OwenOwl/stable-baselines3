...
def create_env(use_gui=False, is_eval=False, obj_scale=1.0, obj_name="tomato_soup_can",
    ...
    import os
    # from hand_teleop.env.rl_env.free_pick_env import FreePEnv
    from hand_teleop.real_dexmv2.real_pick_car import RealAbilityXArmPickCarEnv
    ...
    env_params["hand_smooth"] = 0.99
    env_params["hand_port"] = "/dev/ttyUSB1"
    env = RealAbilityXArmPickCarEnv(**env_params)
...
if __name__ == '__main__':
    ...
    traj_root = "sim_trajs_0403_pick_car"
    traj_idx = 5
