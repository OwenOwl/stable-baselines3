...
if __name__ == '__main__':
    # model_path = "/home/lixing/results/state_laptop-0.002/model/model_1000.zip"
    model_path = "/home/lixing/results/rl_laptop/model/model_1000.zip"
    exp = model_path.split("/")[4]
    ...
    for friction in [1]:
        for scale in [1.5]:
            succeed = 0
            for (object_cat, object_name) in [object_list[2]]:
                seed = 0
                save_str = "pics/"+exp+"_"+object_cat+object_name+"_s"+str(scale)+"_f"+str(friction)+"_r"+str(seed)+"/"
