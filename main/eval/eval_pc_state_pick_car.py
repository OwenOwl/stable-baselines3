...
if __name__ == '__main__':
    ...
    model_path = "/home/lixing/results/pc_state_toycar_dagger/model/model_0.zip"

    object_list = HOI4D_OBJECT_LIST['pick_car'] # IN DISTRIBUTION
            ...
            for ITERS in range(1):
                ...
                for (object_cat, object_name) in tqdm.tqdm(object_list[:]):
                    ...
                    for i in range(lab_env.horizon):
                        ...
                        if lab_done and i < lab_env.horizon - 1:
                            print("cartesian")
                            break
