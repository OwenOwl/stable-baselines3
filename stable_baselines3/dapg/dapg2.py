...
from stable_baselines3.common.on_policy_algorithm2 import OnPolicyAlgorithm2
...
class DAPG2(OnPolicyAlgorithm2):
    """
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values = self.state_model.policy.predict_values(rollout_data.observations["oracle_state"])
