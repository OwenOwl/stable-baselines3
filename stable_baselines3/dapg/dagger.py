...
from stable_baselines3.common.on_policy_algorithm_deter import OnPolicyAlgorithmDeter
...
class Dagger(OnPolicyAlgorithmDeter):
    """
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                actions, _, _ = self.state_model.policy(rollout_data.observations["oracle_state"], deterministic=True)

                # Use teacher policy to distill
                _, expert_log_prob, _ = self.policy.evaluate_actions(rollout_data.observations, actions)
