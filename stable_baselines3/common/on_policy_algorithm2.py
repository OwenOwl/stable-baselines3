...
class OnPolicyAlgorithm2(BaseAlgorithm):
    """
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                _, values, _ = self.state_model.policy(obs_tensor["oracle_state"])
            ...
            for idx, done in enumerate(dones):
                if (
                    ...
                    with th.no_grad():
                        terminal_value = self.state_model.policy.predict_values(terminal_obs["oracle_state"])[0]
        ...
        with th.no_grad():
            ...
            values = self.state_model.policy.predict_values(obs_as_tensor(new_obs, self.device)["oracle_state"])
